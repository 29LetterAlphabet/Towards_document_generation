...
ar2 = ['Destination IP','Destination Port TCP','Destination Port UDP','Source IP','Source Port','Geolocation results of source IPs','Time Series','Cumulative time series','Scatter plot of destination ports against time','Time series of port 22']
ar2s = ['destinationIP','dPortListTCP','dPortListUDP','sourceIP','sourcePort','IPCountry','TimeSeries.png','Cumulative','Dportvstime','port22vs']
